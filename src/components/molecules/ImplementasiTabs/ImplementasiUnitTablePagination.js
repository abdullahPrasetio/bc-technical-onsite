...
function ImplementasiUnitTablePagination({ statusUnit, site_id }) {
                                    ...
                                    <div>
                                        ...
                                        <div className="ml-8 hidden overflow-hidden animate-accordion">
                                            ...
                                            {item.status ===
                                                ...
                                                <>
                                                    <div
                                                        ...
                                                        className="w-full py-2 px-4 rounded block focus:outline-none hover:text-white active:text-white hover:bg-red-700 my-1 flex items-center justify-between"
                                                    >
                                                        Terkendala
                                                    </div>
                                                    <div
                                                        onClick={() =>
                                                            onChangeStatus(
                                                                item.id,
                                                                'Implementasi selesai (menunggu approval)'
                                                            )
                                                        }
                                                        className="w-full py-2 px-4 rounded block focus:outline-none hover:text-white active:text-white hover:bg-gray-700 my-1 flex items-center justify-between"
                                                    >
                                            ...
                                            {item.status ===
                                                ...
                                                <>
                                                    <Link
                                                        to={`/tickets/create/${item.id}/units`}
...
export default ImplementasiUnitTablePagination
