        ...
        <div>
            ...
            <table className="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                <thead className="text-white ">
                    <tr className="bg-gray-700 flex lg:flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0 hidden">
                        <th className="p-3 text-left">Judul</th>
                        <th className="p-3 text-left">Prioritas</th>
                        <th className="p-3 text-left">User Create</th>
...
export default TicketTabPagination
